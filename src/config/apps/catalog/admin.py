...
from config.apps.catalog.models import Category, Brand, ProductAttribute, ProductClass, ProductRecommendation, Product, \
...
class ProductClassAdmin(admin.ModelAdmin):
    list_display = ('title_ir', 'title_en', 'slug', 'require_shipping', 'track_stock', 'attribute_count')
...
class ProductAdmin(admin.ModelAdmin):
    inlines = [ProductAttributeValueInline, ProductImageInline, ProductRecommendationInline, ProductStockRecordInline]
