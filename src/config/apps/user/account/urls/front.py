...
urlpatterns = [
    ...
    path("visit/logged-in/", front.UserVisitLoggedInView.as_view(), name="user_visit_logged_in"),
    path("visit/anonymous/", front.UserVisitAnonymousView.as_view(), name="user_visit_anonymous"),
    ...
    path(
        "edit/phone/request/",
        front.UserEditPhoneRequestView.as_view(),
        name="user_edit_phone_request",
    ),
    path(
        "edit/phone/confirm/",
        front.UserEditPhoneConfirmView.as_view(),
        name="user_edit_phone_confirm",
    ),
    path(
        "edit/email/request/",
        front.UserEditEmailRequestView.as_view(),
        name="user_edit_email_request",
    ),
    path(
        "edit/email/confirm/",
        front.UserEditEmailConfirmView.as_view(),
